...
public:
	...
	inline IndexThreadReduce()
	{
		...
		maxIndex = 0;
		stepSize = 1;
		callPerIndex = std::bind(&IndexThreadReduce::callPerIndexDefault, this, std::placeholders::_1,
								 std::placeholders::_2,
								 std::placeholders::_3,
								 std::placeholders::_4);
...
//		}
		...
		nextIndex = 0;
		maxIndex = 0;
		this->callPerIndex = std::bind(&IndexThreadReduce::callPerIndexDefault, this, std::placeholders::_1,
									   std::placeholders::_2,
									   std::placeholders::_3,
									   std::placeholders::_4);
