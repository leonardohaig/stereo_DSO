...
//			std::cout << stamp <<std::endl;
	...
	std::vector<std::string> files;//the images full path
	std::vector<double> timestamps;//timestamps from times.txt;
	std::vector<float> exposures;//maybe this express the exposure time,and this from times.txt

	int width, height;//the size of image that after undisort
	int widthOrg, heightOrg;//the size of input image
